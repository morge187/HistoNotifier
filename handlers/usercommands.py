...
async def chacge_name(message: Message, state: FSMContext):
    ...
    "   • Шоколад и доппаёк\n"
    "   <i>(исключения будут прописаны ниже)</i>\n\n"
    ...
    "   • При наличии на танке 100/105-октанового бензина или масла танк не может потушиться, даже имея ремкомплект\n\n"
